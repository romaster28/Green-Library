...
namespace GreenLibrary.CharacterController
{
    public class CharacterComponent : MonoBehaviour
    {
        ...
        {
            Gizmos.color = Physics.CheckSphere(transform.position, _config.GroundCheckRadius, _config.Ground)
                ? Color.green
                : Color.red;
            ...
            Func<Vector3, Vector3> calculateDirection = _transformModel == null
                ? transform.TransformDirection
                : _transformModel.TranslateDirection;
